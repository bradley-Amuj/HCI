							...
							<div class="owl-item">
								<div class="trends_item">
									...
									<div class="trends_content">
										...
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">Hinges</a></div>
											<div class="trends_price">$379</div>
										</div>
									</div>
									<ul class="trends_marks">
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									...
									<div class="trends_content">
										...
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">Palette</a></div>
											<div class="trends_price">$379</div>
										</div>
									</div>
									<ul class="trends_marks">
							...
							<div class="owl-item">
								<div class="trends_item">
									...
									<div class="trends_content">
										<div class="trends_category"><a href="#">Gate</a></div>
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">Black Gate</a></div>
											<div class="trends_price">$379</div>
										</div>
									</div>
									<ul class="trends_marks">
